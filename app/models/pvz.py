...
class PVZ(Base):
    ...
    deliveries: Mapped[list["Delivery"]] = relationship("Delivery", back_populates="pvz")
    operators: Mapped[list["User"]] = relationship("User", back_populates="pvz")
    operations: Mapped[list["Operation"]] = relationship("Operation", back_populates="pvz")